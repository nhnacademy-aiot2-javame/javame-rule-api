...
public class SensorDataServiceImpl implements SensorDataService {
    ...
    @Override
    public SensorDataResponse register(SensorDataRegisterRequest sensorDataRegisterRequest) {
        ...
        SensorData sensorData = new SensorData(sensorDataRegisterRequest.getSensor(), sensorDataRegisterRequest.getSensorDataName(),
